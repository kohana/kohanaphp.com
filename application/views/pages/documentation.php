<div id="documentation" class="span-22 prefix-1 suffix-1 last">
	...
	<div id="feature">
		<h2><?php echo HTML::image('media/img/book.png') . 'v3.x Documentation' ?></h2>
		<ul>
			<li><?php echo HTML::anchor('http://kohanaframework.org/3.1/guide/', 'Kohana 3.1.x Documentation') ?></li>
			<li><?php echo HTML::anchor('http://kohanaframework.org/3.0/guide/', 'Kohana 3.0.x Documentation') ?></li>
		</ul>
		<p>Documentation is also included in the <code>userguide module</code> in all releases. Once the userguide module is enabled in the bootstrap, it is accessible from your site with <code>/index.php/guide</code> (or just /guide if you are rewriting your urls).</p>
	</div>
